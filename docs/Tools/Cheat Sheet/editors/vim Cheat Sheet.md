...
## Plugin - [GitHub - tpope/vim-commentary: commentary.vim: comment stuff out](https://github.com/tpope/vim-commentary)
...
## Plugin - [GitHub - junegunn/vim-easy-align: :sunflower: A Vim alignment plugin](https://github.com/junegunn/vim-easy-align)
...
## Plugin - [GitHub - tpope/vim-unimpaired: unimpaired.vim: Pairs of handy bracket mappings](https://github.com/tpope/vim-unimpaired)
...
## Plugin - [GitHub - gaving/vim-textobj-argument: Text-object like motion for arguments](https://github.com/gaving/vim-textobj-argument)
...
- 在行内左右移动光标时，多使用`w b e`或`W B E`，而不是h l或方向键，这样会快很多
